...
router.get("/get-published-form/:formId", function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
...
router.put("/update-form", function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                ...
                if (!result2.rows[0])
                    throw new Error("form draft was not updated");
                res.send(result2.rows[0]);
                return [3 /*break*/, 3];
            case 2:
                error_10 = _a.sent();
...
router.post("/add-new-input-to-form", function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var result1_1, createdInput_1, numCustomProperties_1, error_11;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, database_js_1.pool.query("\n      with inserted as (\n        insert into ".concat(req.body.isForDraft ? "draft_user_created_inputs" : "user_created_inputs", " (\n          input_type_id,\n          ").concat(req.body.isForDraft ? "draft_form_id" : "form_id", ",\n          metadata_question,\n          metadata_description,\n          is_active,\n          ").concat(req.body.isForDraft ? "" : "published_at,", "\n          ").concat(req.body.isForDraft ? "" : "published_by_id,", "\n          created_at,\n          created_by_id,\n          modified_by_id,\n          modified_at\n        ) values (\n          $1,\n          $2,\n          $3,\n          $4,\n          true,\n          ").concat(req.body.isForDraft ? "" : "now(),", "\n          ").concat(req.body.isForDraft ? "" : "$5,", "\n          now(),\n          $5,\n          null,\n          null\n        ) returning * \n      )\n      select a.*,\n      b.name input_type_name\n      from inserted a\n      join input_types b\n      on a.input_type_id = b.id\n    "), [
            ...
            case 1:
                ...
                if (req.body.properties) {
                    req.body.properties.forEach(function (property, i) { return __awaiter(void 0, void 0, void 0, function () {
                        var result;
                        return __generator(this, function (_a) {
                            switch (_a.label) {
                                case 0: return [4 /*yield*/, database_js_1.pool.query("\n          insert into ".concat(req.body.isForDraft
...
router.put("/change-input-enabled-status/:inputId", function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var result, error_12;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, database_js_1.pool.query("\n      update ".concat(req.body.isDraft ? "draft_user_created_inputs" : "user_created_inputs", " \n      set is_active = $1\n      where id = $2\n      returning *\n    "), [req.body.newActiveStatus, req.params.inputId])];
            case 1:
                result = _a.sent();
                if (!result)
